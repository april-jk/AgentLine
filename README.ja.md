...
- 最新公開版：[v1.0.3](https://github.com/april-jk/AgentLine/releases/tag/v1.0.3)
...
| Platform | 直接ダウンロード |
| --- | --- |
| macOS | [DMG をダウンロード](https://github.com/april-jk/AgentLine/releases/latest/download/AgentLine.Desktop-1.0.3-arm64.dmg) |
| Windows | [Installer をダウンロード](https://github.com/april-jk/AgentLine/releases/latest/download/AgentLine.Desktop.Setup.1.0.3.exe) / [Portable をダウンロード](https://github.com/april-jk/AgentLine/releases/latest/download/AgentLine.Desktop.1.0.3.exe) |
| Linux | [AppImage をダウンロード](https://github.com/april-jk/AgentLine/releases/latest/download/agentline-desktop-1.0.3-x86_64.AppImage) / [DEB をダウンロード](https://github.com/april-jk/AgentLine/releases/latest/download/agentline-desktop-1.0.3-amd64.deb) |
| Android | [APK をダウンロード](https://github.com/april-jk/AgentLine/releases/latest/download/AgentLine-Mobile-RN-1.0.3-android.apk) |
