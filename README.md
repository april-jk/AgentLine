...
大多数用户直接下载 [最新 GitHub Release](https://github.com/april-jk/AgentLine/releases/latest) 里的安装包：

| 平台 | 直接下载 |
| --- | --- |
| macOS | [下载 DMG](https://github.com/april-jk/AgentLine/releases/latest/download/AgentLine.Desktop-1.0.1-arm64.dmg) |
| Windows | [下载安装版](https://github.com/april-jk/AgentLine/releases/latest/download/AgentLine.Desktop.Setup.1.0.1.exe) / [下载便携版](https://github.com/april-jk/AgentLine/releases/latest/download/AgentLine.Desktop.1.0.1.exe) |
| Linux | [下载 AppImage](https://github.com/april-jk/AgentLine/releases/latest/download/agentline-desktop-1.0.1-x86_64.AppImage) / [下载 DEB](https://github.com/april-jk/AgentLine/releases/latest/download/agentline-desktop-1.0.1-amd64.deb) |
| Android | [下载 APK](https://github.com/april-jk/AgentLine/releases/latest/download/AgentLine-Mobile-RN-1.0.1-android.apk) |
