...
| **AgentLine** | Mobile-first supervisor with E2E encryption, tiered inbox, fork/clone, multi-agent (Claude/Codex/Gemini) | [kzahel/agentline](https://github.com/kzahel/agentline) | MIT | Kyle Graehl | 206 |
