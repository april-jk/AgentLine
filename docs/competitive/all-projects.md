...
| **AgentLine** | Mobile-first supervisor with E2E encryption, tiered inbox, fork/clone, multi-agent (Claude/Codex/Gemini) | [april-jk/AgentLine](https://github.com/april-jk/AgentLine) | MIT | AgentLine contributors | 206 |
