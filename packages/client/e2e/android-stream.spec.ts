...
const LONG_STREAM_ENV = "AGENTLINE_E2E_ANDROID_LONG_STREAM";
const LONG_STREAM_DURATION_MS_ENV = "AGENTLINE_E2E_ANDROID_LONG_STREAM_MS";
const LONG_STREAM_POLL_MS_ENV = "AGENTLINE_E2E_ANDROID_LONG_STREAM_POLL_MS";
const LONG_STREAM_STALL_MS_ENV = "AGENTLINE_E2E_ANDROID_LONG_STREAM_STALL_MS";
const LONG_STREAM_STARTUP_MS_ENV = "AGENTLINE_E2E_ANDROID_LONG_STREAM_STARTUP_MS";
const LONG_STREAM_NUDGE_MS_ENV = "AGENTLINE_E2E_ANDROID_LONG_STREAM_NUDGE_MS";
