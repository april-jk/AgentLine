...
## [site-v1.5.45] - 2026-05-28

### Added
- Add Google Search Console verification metadata to every website page.
- Add site-level Organization, WebSite, and SoftwareApplication structured data for search engines.
